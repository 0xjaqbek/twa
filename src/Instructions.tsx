          ...
          <div style={{
            ...
            <div style={{
              ...
              <ol style={{ fontSize: '0.6rem' }}>
                ...
                <li>Your goal is to reach 69 clicks as fast as possible1</li><br></br>
              </ol>
              <StyledButton onClick={handleCloseModal}>Close</StyledButton>
            </div>
          </div>
        )}
        {showLeaderboard && <LeaderboardPage elapsedTime={0} onClose={handleCloseModal} telegramId={null} />}
      </div>
    </div>
  );
};
